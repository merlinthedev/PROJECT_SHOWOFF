...
public class LTDescr
{
	...
	public void reset(){
		...
		hasUpdateCallback = useEstimatedTime = useFrames = hasInitiliazed = onCompleteOnRepeat = destroyOnComplete = onCompleteOnStart = useManualTime = hasExtraOnCompletes = toggle = false;
	...
	public LTDescr setRotateAround(){
		...
		easeInternal = ()=>{
			...
			Vector3 rotateAroundPt = (Vector3)trans.TransformPoint( _optional.point );
			...
			rotateAroundPt = (Vector3)trans.TransformPoint( _optional.point );
	...
	public LTDescr setRotateAroundLocal(){
		...
		easeInternal = ()=>{
			...
			val = newVect.x;
			Vector3 origPos = trans.localPosition;
            trans.RotateAround((Vector3)trans.TransformPoint( _optional.point ), trans.TransformDirection(_optional.axis), -_optional.lastVal);
			Vector3 diff = origPos - trans.localPosition;
	...
	public LTDescr setCanvasRotateAround(){
		...
		easeInternal = ()=>{
			...
			rect.RotateAround((Vector3)rect.TransformPoint( _optional.point ), _optional.axis, -val);
	...
	public LTDescr setCanvasRotateAroundLocal(){
		...
		easeInternal = ()=>{
			...
			RectTransform rect = rectTransform;
			Vector3 origPos = rect.localPosition;
			rect.RotateAround((Vector3)rect.TransformPoint( _optional.point ), rect.TransformDirection(_optional.axis), -val);
			Vector3 diff = origPos - rect.localPosition;
	...
	public LTDescr setGUIRotate(){
		...
		initInternal = ()=>{ if(_optional.ltRect.rotateEnabled==false){
...
//		Debug.Log ("tween:" + this+ " dt:"+dt);
	...
	*/
	public LTDescr pause(){
		if(direction != 0.0f){ // check if tween is already paused
